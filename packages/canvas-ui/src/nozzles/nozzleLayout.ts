 ...
 */
import type { NodeKind, NodePort, NozzleDressing, ProcessNode, UnitOpDressing } from '@process-forge/protocol';
...
export function standardNozzles(kind: NodeKind | string): NozzleDressing[] {
  switch (kind) {
    ...
    case 'PALLETIZER':
      return [n('N1', 'Infeed', 'inlet', 12.5, 74.3, 'left', 'in-containers')];
    default:
