...
if (-not $downloadSuccess) {
    ...
    $downloadCandidates += "https://omeaga1.github.io/process-forge/process-forge-windows-portable-x64.zip"
    $downloadCandidates += "https://raw.githubusercontent.com/$repo/main/release-dist/process-forge-windows-portable-x64.zip"
    $downloadCandidates += "https://github.com/$repo/releases/download/v0.1.2/process-forge-windows-portable-x64.zip"
