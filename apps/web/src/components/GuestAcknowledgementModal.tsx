...
import { ShieldAlert, Download, UserPlus, ArrowRight, X } from 'lucide-react';
      ...
      >
        ...
        <div style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 16 }}>
          <p style={{ margin: 0, fontSize: 14, lineHeight: 1.6, color: OsakaJadePalette.text.primary }}>
            Welcome to ProcessForge! You have full access to the interactive canvas, the local deterministic simulation engine, and all machine-level sub-agents.
          </p>
          ...
          >
            <strong style={{ color: OsakaJadePalette.border.glowAmber }}>Notice on Progress Saving:</strong> Because you are not logged in, your digital twin is stored only in your browser’s temporary storage. If you close your private window or clear your browser data, your changes cannot be recovered.
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <UserPlus size={18} color={OsakaJadePalette.text.primary} />
                <div>
                  <div style={{ fontSize: 13, fontWeight: 600, color: OsakaJadePalette.text.primary }}>
                    Create Free Account / Sign In
                  </div>
                  <div style={{ fontSize: 11, color: OsakaJadePalette.text.secondary }}>
                    Sync simulations across devices with team collaboration and version history.
                  </div>
                </div>
              </div>
              <button
